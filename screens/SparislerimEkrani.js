...
import FoodCardForOrders from "../assets/component/foodCardForOrders";
...
export default function SparislerimEkrani({ navigation, route, params }) {
  ...
  //buraya tum verileri cek medicines ile limitle, yani filtrele bunu parametre olarak gonder, adeti paramete olark gonder, ve ezane id yi parametre oalrak gonder sonradan duzenleme yaparsin
